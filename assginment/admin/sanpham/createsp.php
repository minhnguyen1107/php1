...
?>
    ...
    <?php endif ?>
    <form class="form-group" action="createsp.php" method="POST" enctype="multipart/form-data">
        <input type="text" class="form-control" name="title" placeholder="Tên sản phẩm" id="">
        <br>
        <!--Danh mục-->
        ...
        <br>
        <textarea name="description" id="" class="form-control" placeholder="Mô tả"></textarea>
        <br>
        <textarea name="content" class="form-control" placeholder="Nội dung"></textarea>
        <input type="text" class="form-control" name="price" id="" placeholder="Giá"></textarea>
        <br>
